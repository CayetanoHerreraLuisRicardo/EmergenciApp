...
namespace AppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("6688674a-5040-43e9-932d-aad03b4a1fe9");
        public const string APP_NAME = "EmergenciApp";
        ...
        {
            TileServices.CreateIconicTile(@"Telefonos de emergencias Df", @"Telefono de Asistencia Df", @"Emergencias México");
        }
        #endregion
    }
}
